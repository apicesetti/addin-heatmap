...
geotab.addin.heatmap = function () {
  ...
  var T = function (e) {
      e
        ? ((i.disabled = !0), (c.style.display = "block"))
        : (setTimeout(function () {
        ...
        for (
          ...
          d.push([
            "Get",
            {
              typeName: "LogRecord",
              resultsLimit: I,
              search: { deviceSearch: { id: t[u] }, fromDate: r, toDate: c },
            },
          ]);
        v.multiCall(
          d,
          function (e) {
            ...
            for (
              var t = [], n = [], o = 0, a = 0, i = [], l = 0, r = e.length;
              l < r;
              l++
            ) {
              i = e[l];
              for (var c = 0; c < i.length; c++)
                (0 === i[c].latitude && 0 === i[c].longitude) ||
                  ...
                  n.push(new L.LatLng(i[c].latitude, i[c].longitude)),
                  o++);
              i.length >= I && a++;
            }
            (0 < t.length
              ? (h.fitBounds(n),
                ...
                B(
                  "Displaying "
                    .concat(S(o), " combined log records for the\n        ")
                    .concat(S(D), " selected vehicles. [")
                    .concat(N(), " sec]"),
                ),
                0 < a &&
                  b(
                    "Note: Not all results are displayed because the result limit of \n          "
    ...
    o = function () {
      ...
      for (
        var e,
          t = p.options[p.selectedIndex].value,
          g = p.options[p.selectedIndex].text,
          n = [],
          o = y.options,
          a = 0,
          i = o.length;
      ...
      var l = E.value,
        r = w.value;
      if ((b(""), B(""), null !== n && null !== t && "" !== l && "" !== r)) {
        T(!0);
        for (
          var c = new Date(l).toISOString(),
          ...
          function (e) {
            ...
            v.multiCall(
              ...
              function (e) {
                if (x(e)) return (b("No data to display"), void T(!1));
                for (
                  var t = [], n = [], o = 0, a = 0, i = 0, l = e.length;
                  i < l;
                  i++
                ) {
                  for (var r = e[i], c = 0; c < r.length; c++)
                    (0 === r[c].latitude && 0 === r[c].longitude) ||
                      ...
                      n.push(new L.LatLng(r[c].latitude, r[c].longitude)),
                      o++);
                  r.length >= I && a++;
                }
                if (0 < t.length) {
                  if (
                    ...
                    B(
                      "Displaying "
                        .concat(
                          S(o),
                          " combined log records associated with the\n          ",
                        )
                        .concat(S(u), " '")
                        .concat(
                          g,
                          "' rule exceptions found for the \n          ",
                        )
                        .concat(S(D), " selected vehicles. [")
                        .concat(N(), " sec]"),
                    ),
                    ...
                    (s &&
                      (d += " the result limit of \n              "
                        .concat(S(I), " was exceeded for '")
                        .concat(g, "' rule exceptions")),
                      0 < s && 0 < a && (d += " and"),
                      0 < a &&
                        (d += " the result limit of \n              "
                          .concat(S(I), " was exceeded for \n              ")
                          .concat(
                            S(exceededResultsLimitCount),
    ...
    a = function (e) {
      ...
      (n < 10 && (n = "0" + n),
        ...
        document
          .getElementById("visualizeByLocationHistory")
          .addEventListener("click", function (e) {
            p.disabled = !0;
          }),
        document
          .getElementById("visualizeByExceptionHistory")
          .addEventListener("click", function (e) {
            p.disabled = !1;
          }),
        document
          .getElementById("exceptionTypes")
        ...
        document
          .getElementById("showHeatMap")
          .addEventListener("click", function (e) {
            (e.preventDefault(), d());
          }));
    },
    u = function (e, t) {
      return (e = e.name.toLowerCase()) === (t = t.name.toLowerCase())
        ? 0
        : t < e
          ? 1
          : -1;
  ...
  return {
    ...
    focus: function (e, t) {
      ((v = e).call(
        ...
        v.call(
          "Get",
          { typeName: "Rule", resultsLimit: 5e4 },
          function (e) {
            !e ||
              e.length < 0 ||
              (e.sort(u),
