(!(function (t, i) {
  ...
  function M(t, i, e) {
    if (!e || b !== P) return b.call(window, m(t, i));
    t.call(i);
  }
  function z(t) {
    t && T.call(window, t);
  ...
  ((k.prototype = {
    ...
    (R.prototype = {
      ...
      pad: function (t) {
        ...
        return new R(new N(i.lat - n, i.lng - o), new N(e.lat + n, e.lng + o));
      },
      getCenter: function () {
        return new N(
      ...
      contains: function (t) {
        t = ("number" == typeof t[0] || t instanceof N || "lat" in t ? j : D)(
          t,
        );
        var i,
          e,
  ...
  var H,
    ...
    V = {
      ...
      bounds: new I([-(H = U * Math.PI), -H], [H, H]),
    };
  function q(t, i, e, n) {
    if (g(t))
      return (
  ...
  var Q = document.documentElement.style,
    ...
    rt = ot && kt("Google") && at < 537 && !("AudioNode" in window),
    ht = !!window.opera,
    ut = !et && kt("chrome"),
  ...
  var Ut,
    ...
    Kt,
    Yt,
    Xt = Lt ? "MSPointerDown" : Pt ? "pointerdown" : "touchstart",
    Jt = Lt ? "MSPointerUp" : Pt ? "pointerup" : "touchend",
    $t = "_leaflet_",
    Qt = mi([
      "transform",
      "webkitTransform",
  ...
  function li(t, i) {
    ...
    else ui(t, i) || _i(t, ((e = di(t)) ? e + " " : "") + i);
  }
  function ci(t, i) {
    void 0 !== t.classList
      ? t.classList.remove(i)
      : _i(t, u((" " + di(t) + " ").replace(" " + i + " ", " ")));
  }
  function _i(t, i) {
  ...
  function wi(t) {
    ...
    t.style &&
      ...
      Mi(window, "keydown", Li));
  }
  function Li() {
    Kt &&
      ((Kt.style.outline = Yt), (Yt = Kt = void 0), Ci(window, "keydown", Li));
  }
  function Pi(t) {
    for (
      ;
  ...
  function Mi(t, i, e, n) {
    ...
    else for (var s = 0, a = (i = l(i)).length; s < a; s++) Ei(t, i[s], e, n);
    return this;
  }
  ...
  function Ci(t, i, e, n) {
    if ("object" == typeof i) for (var o in i) ki(t, o, i[o], e);
      ...
      for (var s = 0, a = (i = l(i)).length; s < a; s++) ki(t, i[s], e, n);
    else {
      for (var r in t[zi]) ki(t, r, t[zi][r]);
      delete t[zi];
    }
    return this;
  }
  ...
  function Ei(i, t, e, n) {
    ...
    function p(t) {
      if (l && !u.cancelBubble) {
        ...
        ((u.type = "dblclick"), (u.button = 0), a(u), (h = null));
      }
    }
    (Pt && 0 === t.indexOf("touch")
      ? (function (t, i, e, n) {
          function o(t) {
            Ft(t, a);
          }
          ...
          "touchstart" === i
            ? ((u = t),
              ...
              Nt ||
                ...
                document.addEventListener(Rt, Wt, !0),
                (Nt = !0)))
            : "touchmove" === i
              ? ((h = e),
                ((r = t)["_leaflet_touchmove" + n] = d),
                r.addEventListener(It, d, !1))
              : "touchend" === i &&
                ((a = e),
      ...
      : bt && "dblclick" === t && !Si()
        ? ((a = c),
          ...
          (s[$t + Jt + r] = p),
          (s[$t + "dblclick" + r] = a),
          s.addEventListener(Xt, d, !!Ct && { passive: !1 }),
          s.addEventListener(Jt, p, !!Ct && { passive: !1 }),
          s.addEventListener("dblclick", a, !1))
        : "addEventListener" in i
          ? "touchstart" === t ||
            "touchmove" === t ||
            "wheel" === t ||
            "mousewheel" === t
            ? i.addEventListener(Zi[t] || t, c, !!Ct && { passive: !1 })
            : "mouseenter" === t || "mouseleave" === t
              ? ((c = function (t) {
                  ((t = t || window.event), Ui(i, t) && _(t));
                }),
                i.addEventListener(Zi[t], c, !1))
    ...
    (Pt && 0 === i.indexOf("touch")
      ...
      : bt && "dblclick" === i && !Si()
        ? ((a = (o = t)[$t + Xt + (s = _)]),
          (r = o[$t + Jt + s]),
          (h = o[$t + "dblclick" + s]),
          o.removeEventListener(Xt, a, !!Ct && { passive: !1 }),
          o.removeEventListener(Jt, r, !!Ct && { passive: !1 }),
          o.removeEventListener("dblclick", h, !1))
        : "removeEventListener" in t
          ? t.removeEventListener(Zi[i] || i, d, !1)
  ...
  function Ii(t) {
    return (
      Mi(t, "mousedown touchstart dblclick", Bi),
      Ei(t, "click", Wi),
      this
    );
  }
    ...
    Gi = E.extend({
      ...
      initialize: function (t, i) {
        ((i = c(this, i)),
          ...
          this.callInitHooks(),
          (this._zoomAnimated = ti && vt && !Tt && this.options.zoomAnimation),
          this._zoomAnimated &&
      ...
      flyTo: function (r, h, t) {
        if (!1 === (t = t || {}).animate || !vt) return this.setView(r, h, t);
        this._stop();
        var u = this.project(this.getCenter()),
          l = this.project(r),
          i = this.getSize(),
          c = this._zoom;
        ((r = j(r)), (h = void 0 === h ? c : h));
        var _ = Math.max(i.x, i.y),
          n = _ * this.getZoomScale(c, h),
          d = l.distanceTo(u) || 1,
          p = 1.42,
          m = p * p;
        function e(t) {
          var i =
              (n * n - _ * _ + (t ? -1 : 1) * m * m * d * d) /
              (2 * (t ? n : _) * m * d),
            e = Math.sqrt(i * i + 1) - i;
        ...
        var y = Date.now(),
          x = (e(1) - v) / p,
          w = t.duration ? 1e3 * t.duration : 1e3 * x * 0.8;
        return (
      ...
      _handleGeolocationResponse: function (t) {
        var i,
          e = new N(t.coords.latitude, t.coords.longitude),
      ...
      getBoundsZoom: function (t, i, e) {
        ...
        var n = this.getZoom() || 0,
          ...
          u = O(this.project(r, n), this.project(a, n)).getSize(),
      ...
      _initContainer: function (t) {
        ...
        (Mi(i, "scroll", this._onScroll, this), (this._containerId = f(i)));
      },
      ...
      _initEvents: function (t) {
        ...
        var i = t ? Ci : Mi;
        (i(
          (this._targets[f(this._container)] = this)._container,
  ...
  var Xi = Yi.extend({
      ...
      _initLayout: function () {
        ...
        ((o.href = "#"),
          (o.title = "Layers"),
          bt
            ? (Mi(o, "click", Ri), Mi(o, "click", this.expand, this))
      ...
      _getLayer: function (t) {
        for (var i = 0; i < this._layers.length; i++)
          if (this._layers[i] && f(this._layers[i].layer) === t)
      ...
      _onLayerChange: function (t) {
        ...
        var i = this._getLayer(f(t.target)),
          e = i.overlay
            ? "add" === t.type
              ? "overlayadd"
              : "overlayremove"
      ...
      _addItem: function (t) {
        ...
        (t.overlay
          ? (((i = document.createElement("input")).type = "checkbox"),
            ...
            (i.defaultChecked = n))
          : (i = this._createRadioElement("leaflet-base-layers_" + f(this), n)),
  ...
  (Gi.mergeOptions({ zoomControl: !0 }),
    Gi.addInitHook(function () {
      this.options.zoomControl &&
        ((this.zoomControl = new Ji()), this.addControl(this.zoomControl));
    }));
  var $i = Yi.extend({
      options: {
        position: "bottomleft",
    ...
    Qi = Yi.extend({
      ...
      onAdd: function (t) {
        for (var i in (((t.attributionControl = this)._container = oi(
          "div",
    ...
    ae = E.extend({
      ...
      disable: function () {
        this._enabled &&
          ...
          Ci(this._dragStartTarget, ne, this._onDown, this),
          (this._enabled = !1),
          (this._moved = !1));
      },
      _onDown: function (t) {
        ...
        !t._simulated &&
          ...
          ui(this._element, "leaflet-zoom-anim") ||
            ...
            ((ae._dragging = this)._preventOutline && wi(this._element),
            yi(),
            qt(),
            this._moving ||
              (this.fire("down"),
      ...
      _onMove: function (t) {
        ...
        !t._simulated &&
          ...
          (t.touches && 1 < t.touches.length
            ? (this._moved = !0)
            : ((e = new k(
                (i = t.touches && 1 === t.touches.length ? t.touches[0] : t)
                  .clientX,
                i.clientY,
      ...
      finishDrag: function () {
        ...
        se))
          (Ci(document, se[t], this._onMove, this),
            Ci(document, oe[t], this._onUp, this));
        (xi(),
          Gt(),
          this._moved &&
            this._moving &&
      ...
      ((n[0] = n[e - 1] = 1),
        (function t(i, e, n, o, s) {
          var a,
            ...
            u = 0;
          for (r = o + 1; r <= s - 1; r++)
            u < (h = _e(i[r], i[o], i[s], !0)) && ((a = r), (u = h));
          n < u && ((e[a] = 1), t(i, e, n, o, a), t(i, e, n, a, s));
        })(t, n, i, 0, e - 1));
      var o,
        s = [];
  ...
  function fe(t, i, e) {
    for (
      var n, o, s, a, r, h, u, l = [1, 4, 2, 8], c = 0, _ = t.length;
      c < _;
      c++
    )
      t[c]._code = ce(t[c], i);
    for (s = 0; s < 4; s++) {
      for (h = l[s], n = [], c = 0, o = (_ = t.length) - 1; c < _; o = c++)
        ((a = t[c]),
          ...
          a._code & h
            ? r._code & h ||
              (((u = le(r, a, h, i, e))._code = ce(u, i)), n.push(u))
            : (r._code & h &&
                (((u = le(r, a, h, i, e))._code = ce(u, i)), n.push(u)),
              n.push(a)));
      t = n;
  ...
  var ge,
    ...
    we = { LonLat: ye, Mercator: xe, SphericalMercator: V },
    Le = h({}, F, {
      code: "EPSG:3395",
      projection: xe,
      transformation: G((ge = 0.5 / (Math.PI * xe.R)), 0.5, -ge, 0.5),
    }),
    Pe = h({}, F, {
      code: "EPSG:4326",
      projection: ye,
  ...
  var Me = Te.extend({
    ...
    Ze = te.extend({
      ...
      _adjustPan: function (t) {
        var i,
          ...
          r = n.getPixelBounds(),
          h = n.getPixelOrigin(),
          u = O(r.min._subtract(h).add(s), r.max._subtract(h).subtract(s));
        u.contains(a) ||
          ((i = A(
          ...
          gi(e._icon, this._draggable._newPos),
          this._onDrag(t),
    ...
    Ie = ke.extend({
      ...
      closestLayerPoint: function (t) {
        for (
          var i, e, n = 1 / 0, o = null, s = _e, a = 0, r = this._parts.length;
          a < r;
          a++
        )
      ...
      _containsPoint: function (t, i) {
        ...
        for (e = 0, s = this._parts.length; e < s; e++)
          for (n = 0, o = (a = (r = this._parts[e]).length) - 1; n < a; o = n++)
            if ((i || 0 !== n) && he(t, r[o], r[n]) <= h) return !0;
        return !1;
      },
    });
  Ie._flat = pe;
  var Oe = Ie.extend({
      ...
      _convertLatLngs: function (t) {
        var i = Ie.prototype._convertLatLngs.call(this, t),
          e = i.length;
        return (
          2 <= e && i[0] instanceof N && i[0].equals(i[e - 1]) && i.pop(),
          i
        );
      },
      _setLatLngs: function (t) {
  ...
  function De(t, i) {
    ...
    switch (a.type) {
      case "Point":
        return Ne(u, t, (e = l(r)), i);
      case "MultiPoint":
        for (o = 0, s = r.length; o < s; o++)
          ((e = l(r[o])), h.push(Ne(u, t, e, i)));
        return new ze(h);
      case "LineString":
      case "MultiLineString":
        return ((n = He(r, "LineString" === a.type ? 0 : 1, l)), new Ie(n, i));
      case "Polygon":
      case "MultiPolygon":
        return ((n = He(r, "Polygon" === a.type ? 1 : 2, l)), new Oe(n, i));
  ...
  function He(t, i, e) {
    for (var n, o = [], s = 0, a = t.length; s < a; s++)
      ((n = i ? He(t[s], i - 1, e) : (e || je)(t[s])), o.push(n));
    return o;
  }
  function We(t, i) {
    return (
  ...
  function Fe(t, i, e, n) {
    for (var o = [], s = 0, a = t.length; s < a; s++)
      o.push(i ? Fe(t[s], i - 1, e, n) : We(t[s], n));
    return (!i && e && o.push(o[0]), o);
  }
  function Ue(t, i) {
    return t.feature ? h({}, t.feature, { geometry: i }) : Ve(i);
  }
  function Ve(t) {
  ...
  var qe = {
    toGeoJSON: function (t) {
      return Ue(this, { type: "Point", coordinates: We(this.getLatLng(), t) });
    },
  };
  function Ge(t, i) {
    return new Re(t, i);
  ...
  (Ee.include(qe),
    ...
    Oe.include({
      toGeoJSON: function (t) {
        ...
        return (
          i || (n = [n]),
          Ue(this, { type: (e ? "Multi" : "") + "Polygon", coordinates: n })
        );
      },
    }),
    Me.include({
        ...
        return (
          this.eachLayer(function (t) {
            ...
            t.toGeoJSON &&
              ...
              o
                ? s.push(i.geometry)
                : "FeatureCollection" === (e = Ve(i)).type
                  ? s.push.apply(s, e.features)
                  : s.push(e));
          }),
          o
            ? Ue(this, { geometries: s, type: "GeometryCollection" })
  ...
  var Ke = Ge,
    Ye = Te.extend({
      ...
      initialize: function (t, i, e) {
        ((this._url = t), (this._bounds = D(i)), c(this, e));
      },
      onAdd: function () {
        (this._image ||
          (this._initImage(),
      ...
      _initImage: function () {
        ...
        if (
          ...
          for (var s = 0; s < this._url.length; s++) {
            var a = oi("source");
            ((a.src = this._url[s]), i.appendChild(a));
          }
        }
      },
    }),
    ...
    Qe = $e.extend({
      ...
      onAdd: function (t) {
        ($e.prototype.onAdd.call(this, t),
          ...
          this._source &&
            ...
            this._source instanceof ke || this._source.on("preclick", Bi)));
      },
      onRemove: function (t) {
        ($e.prototype.onRemove.call(this, t),
          ...
          this._source &&
            ...
            this._source instanceof ke || this._source.off("preclick", Bi)));
      },
      getEvents: function () {
      ...
      _initLayout: function () {
        var t,
          i = "leaflet-popup",
          e = (this._container = oi(
            "div",
            i + " " + (this.options.className || "") + " leaflet-zoom-animated",
          )),
          n = (this._wrapper = oi("div", i + "-content-wrapper", e));
        ((this._contentNode = oi("div", i + "-content", n)),
          Ii(e),
          Ai(this._contentNode),
          Mi(e, "contextmenu", Bi),
          (this._tipContainer = oi("div", i + "-tip-container", e)),
          (this._tip = oi("div", i + "-tip", this._tipContainer)),
          this.options.closeButton &&
            (((t = this._closeButton = oi("a", i + "-close-button", e)).href =
              "#close"),
            (t.innerHTML = "&#215;"),
            Mi(t, "click", this._onCloseButtonClick, this)));
      },
      _updateLayout: function () {
        ...
        (o && o < n ? ((i.height = o + "px"), li(t, s)) : ci(t, s),
      ...
      bindPopup: function (t, i) {
        return (
          t instanceof Qe
            ...
            : ((this._popup && !i) || (this._popup = new Qe(i, this)),
  ...
  var tn = $e.extend({
    ...
    _setPosition: function (t) {
      ...
      ((t = t
        ...
        .add(u)
        .add(l)),
        ci(n, "leaflet-tooltip-right"),
        ci(n, "leaflet-tooltip-left"),
        ci(n, "leaflet-tooltip-top"),
        ci(n, "leaflet-tooltip-bottom"),
        li(n, "leaflet-tooltip-" + a),
        gi(n, t));
    },
    _updatePosition: function () {
      ...
      bindTooltip: function (t, i) {
        return (
          t instanceof tn
            ...
            : ((this._tooltip && !i) || (this._tooltip = new tn(i, this)),
  ...
  var nn = Te.extend({
      ...
      bringToFront: function () {
        return (
          this._map && (ri(this._container), this._setAutoZIndex(Math.max)),
          this
        );
      },
      bringToBack: function () {
        return (
          this._map && (hi(this._container), this._setAutoZIndex(Math.min)),
          this
        );
      },
      getContainer: function () {
          ...
          if (
            ...
            if (1 < Math.abs(e - this._tileZoom)) this._setView(t, e);
              ...
              if (
                ...
                for (_ = 0; _ < a.length; _++) this._addTile(a[_], m);
      ...
      _initTile: function (t) {
        ...
        ((t.style.width = i.x + "px"),
          ...
          (t.onselectstart = r),
          (t.onmousemove = r),
          it && this.options.opacity < 1 && pi(t, this.options.opacity),
      ...
      _addTile: function (t, i) {
        ...
        (this._initTile(o),
          this.createTile.length < 2 && M(m(this._tileReady, this, t, null, o)),
          gi(o, e),
    ...
    on = nn.extend({
      ...
      createTile: function (t, i) {
        ...
        return (
          Mi(e, "load", m(this._tileOnLoad, this, i, e)),
          Mi(e, "error", m(this._tileOnError, this, i, e)),
          (!this.options.crossOrigin && "" !== this.options.crossOrigin) ||
            (e.crossOrigin =
              !0 === this.options.crossOrigin ? "" : this.options.crossOrigin),
          (e.alt = ""),
      ...
      _tileOnLoad: function (t, i) {
        it ? setTimeout(m(t, this, null, i), 0) : t(null, i);
      },
  ...
  var an = on.extend({
    ...
    getTileUrl: function (t) {
      var i = this._tileCoordsToNwSe(t),
        ...
        s = n.max,
        a = (
          1.3 <= this._wmsVersion && this._crs === Pe
            ? [o.y, o.x, s.y, s.x]
            : [o.x, o.y, s.x, s.y]
        ).join(","),
      ...
      return (
        r +
        _(this.wmsParams, r, this.options.uppercase) +
  ...
  var rn = Te.extend({
      ...
      onAdd: function () {
        (this._container ||
          (this._initContainer(),
          this._zoomAnimated && li(this._container, "leaflet-zoom-animated")),
          this.getPane().appendChild(this._container),
          this._update(),
      ...
      _updateTransform: function (t, i) {
        ...
        vt ? fi(this._container, r, e) : gi(this._container, r);
      },
      _reset: function () {
    ...
    hn = rn.extend({
      ...
      _initPath: function (t) {
        ...
        var i = ((this._layers[f(t)] = t)._order = {
          layer: t,
          prev: this._drawLast,
          next: null,
        });
  ...
  var ln = (function () {
    ...
    cn = {
      ...
      _removePath: function (t) {
        var i = t._container;
        (si(i), t.removeInteractiveTarget(i), delete this._layers[f(t)]);
      },
      _updateStyle: function (t) {
        var i = t._stroke,
          e = t._fill,
  ...
  ((dn.create = _n),
    (dn.pointsToPath = $),
    (Re.geometryToLayer = De),
    (Re.coordsToLatLng = je),
    (Re.coordsToLatLngs = He),
    (Re.latLngToCoords = We),
    (Re.latLngsToCoords = Fe),
    (Re.getFeature = Ue),
    (Re.asFeature = Ve),
  ...
  var fn = te.extend({
    ...
    _finish: function () {
      (this._moved && (si(this._box), ci(this._container, "leaflet-crosshair")),
        Gt(),
        xi(),
        Ci(
          document,
  ...
  (Gi.addInitHook("addHandler", "boxZoom", fn),
  ...
  (Gi.addInitHook("addHandler", "doubleClickZoom", gn),
    Gi.mergeOptions({
      dragging: !0,
      inertia: !st,
  ...
  (Gi.addInitHook("addHandler", "dragging", vn),
  ...
  (Gi.addInitHook("addHandler", "keyboard", yn),
    Gi.mergeOptions({
      scrollWheelZoom: !0,
  ...
  (Gi.addInitHook("addHandler", "scrollWheelZoom", xn),
  ...
  var wn = te.extend({
    ...
    _onUp: function (t) {
      ...
      (clearTimeout(this._holdTimeout),
        Ci(document, { touchmove: this._onMove, touchend: this._onUp }, this),
        this._fireClick &&
          t &&
          t.changedTouches &&
  ...
  (!bt || (Pt && !ct) || Gi.addInitHook("addHandler", "tap", wn),
    Gi.mergeOptions({ touchZoom: bt && !st, bounceAtZoomLimits: !0 }));
  var Ln = te.extend({
    addHooks: function () {
    ...
    _onTouchMove: function (t) {
      if (t.touches && 2 === t.touches.length && this._zooming) {
        ...
        (this._moved || (i._moveStart(!0, !1), (this._moved = !0)),
          z(this._animRequest));
        var a = m(i._move, i, this._center, this._zoom, {
          pinch: !0,
          round: !1,
        });
        ((this._animRequest = M(a, this, !0)), Oi(t));
      }
    },
  ...
  (Gi.addInitHook("addHandler", "touchZoom", Ln),
    (Gi.BoxZoom = fn),
    (Gi.DoubleClickZoom = gn),
    (Gi.Drag = vn),
    (Gi.Keyboard = yn),
    (Gi.ScrollWheelZoom = xn),
    (Gi.Tap = wn),
    (Gi.TouchZoom = Ln),
    (t.version = "1.7.1"),
    (t.Control = Yi),
    ...
    ((i.prototype = {
      ...
      radius: function (t, i) {
        ...
        var e = (this._circle = document.createElement("canvas")),
          ...
          o = (this._r = t + i);
        return (
          (e.width = e.height = 2 * o),
          (n.shadowOffsetX = n.shadowOffsetY = 200),
          (n.shadowBlur = i),
          (n.shadowColor = "black"),
          n.beginPath(),
          n.arc(o - 200, o - 200, t, 0, 2 * Math.PI, !0),
          n.closePath(),
          n.fill(),
          this
        );
      ...
      gradient: function (t) {
        ...
        for (var o in ((i.width = 1), (i.height = 256), t))
          n.addColorStop(o, t[o]);
        return (
          (e.fillStyle = n),
          e.fillRect(0, 0, 1, 256),
          (this._grad = e.getImageData(0, 0, 1, 256).data),
          this
        );
      },
      draw: function (t) {
        ...
        for (var e, n = 0, o = this._data.length; n < o; n++)
          ((e = this._data[n]),
            (i.globalAlpha = Math.max(e[2] / this._max, t || 0.05)),
            i.drawImage(this._circle, e[0] - this._r, e[1] - this._r));
        var s = i.getImageData(0, 0, this._width, this._height);
        return (
          this._colorize(s.data, this._grad),
          i.putImageData(s, 0, 0),
          this
        );
      },
      _colorize: function (t, i) {
        for (var e, n = 3, o = t.length; n < o; n += 4)
          (e = 4 * t[n]) &&
            ((t[n - 3] = i[e]), (t[n - 2] = i[e + 1]), (t[n - 1] = i[e + 2]));
      },
    }),
      (window.simpleheat = i));
  })(),
  (L.HeatLayer = (L.Layer ? L.Layer : L.Class).extend({
    ...
    _redraw: function () {
      var t,
        ...
        l = this._heat._r,
        c = this._map.getSize(),
        _ = new L.LatLngBounds(
          this._map.containerPointToLatLng(L.point([-l, -l])),
          this._map.containerPointToLatLng(c.add([l, l])),
        ),
        d =
          void 0 === this.options.maxZoom
            ? this._map.getMaxZoom()
            : this.options.maxZoom,
        p = 1 / Math.pow(2, Math.max(0, Math.min(d - this._map.getZoom(), 12))),
        m = l / 2,
        f = [],
      ...
      for (t = 0, i = this._latlngs.length; t < i; t++)
        _.contains(this._latlngs[t]) &&
          ((e = this._map.latLngToContainerPoint(this._latlngs[t])),
          (o = Math.floor((e.x - v) / m) + 2),
          (s = Math.floor((e.y - y) / m) + 2),
          (h = (this._latlngs[t].alt || 1) * p),
          (f[s] = f[s] || []),
          (n = f[s][o])
            ? ((n[0] = (n[0] * n[2] + e.x * h) / (n[2] + h)),
              (n[1] = (n[1] * n[2] + e.y * h) / (n[2] + h)),
              (n[2] += h))
            : (f[s][o] = [e.x, e.y, h]));
      for (t = 0, i = f.length; t < i; t++)
        if (f[t])
          for (a = 0, r = f[t].length; a < r; a++)
            (n = f[t][a]) &&
              u.push([Math.round(n[0]), Math.round(n[1]), Math.min(n[2], 1)]);
      (this._heat.data(u).draw(), (this._frame = null));
    },
    _animateZoom: function (t) {
      var i = this._map.getZoomScale(t.zoom),
        e = this._map
      ...
      L.DomUtil.setTransform
        ? L.DomUtil.setTransform(this._canvas, e, i)
        : (this._canvas.style[L.DomUtil.TRANSFORM] =
            L.DomUtil.getTranslateString(e) + " scale(" + i + ")");
    },
  })),
